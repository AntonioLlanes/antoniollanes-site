...
<main class="min-h-screen text-black font-sans relative overflow-x-hidden bg-pink-100">
  <!-- Hero Section -->
  <section class="flex flex-col items-center justify-center h-screen text-center px-4 bg-black">
    ...
    <p class="fade-section opacity-0 translate-y-6 transition-all duration-1000 mt-4 text-lg text-white font-light font-sans">Full-stack developer and creative technologist focused on building performant, user-driven digital experiences.</p>
  </section>

  <!-- Transition Ombre Strip -->
  <section class="h-16 w-full bg-gradient-to-b from-black to-pink-100"></section>

  <!-- About Section -->
  <section class="px-8 py-16 max-w-3xl mx-auto bg-pink-100 font-sans">
  ...
  <!-- Projects Section -->
  <section class="px-8 py-16 max-w-5xl mx-auto bg-pink-100 font-sans">
    <div class="fade-section opacity-0 translate-y-6 transition-all duration-1000 p-6">
      ...
      <div class="grid gap-8 md:grid-cols-2">
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-pink-200">
          ...
          <div class="mt-2 flex flex-col gap-1">
            <a href="https://www.vintagememere.com" target="_blank" class="inline-block text-sm text-pink-800 hover:text-black underline">✨ Visit VintageMemere.com</a>
            <a href="https://github.com/antoniollanes/vintage" target="_blank" class="inline-block text-sm text-pink-800 hover:text-black underline">View GitHub Repo →</a>
          </div>
        </div>
        <div class="bg-white rounded-2xl shadow-lg p-6 border border-pink-200">
          ...
          <a href="https://github.com/antoniollanes/antoniollanes-site" target="_blank" class="inline-block text-sm text-pink-800 hover:text-black underline mt-2">View GitHub Repo →</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- Tech Stack Section -->
  <section class="px-8 py-16 max-w-4xl mx-auto bg-pink-100 font-sans">
    <div class="fade-section opacity-0 translate-y-6 transition-all duration-1000 p-6">
  ...
  <!-- Resume Section -->
  <section class="px-8 py-16 max-w-5xl mx-auto text-center bg-pink-100 font-sans">
    <div class="fade-section opacity-0 translate-y-6 transition-all duration-1000 p-6">
  ...
  <!-- Contact Section -->
  <section class="px-8 py-16 max-w-3xl mx-auto text-center bg-pink-100 font-sans">
    <div class="fade-section opacity-0 translate-y-6 transition-all duration-1000 p-6">
      <h2 class="text-4xl font-bold text-black mb-4 font-serif">Contact</h2>
      <p class="text-black mb-6 text-sm font-light">
        Reach out via <a href="mailto:antoniojllanes@gmail.com" class="underline text-black hover:text-pink-600">email</a> or find me on
        <a href="https://github.com/antoniollanes" class="underline text-black hover:text-pink-600">GitHub</a>.
      </p>
    </div>
  </section>

  <footer class="text-center py-8 text-xs text-black bg-pink-100 font-sans">
